...
//        JPanel menu=new JPanel(new GridLayout(14, 1));
        ...
        JLabel logo=new JLabel(Tool.showIcon(width_menu, 200, "src/Images/Icon/1200px-Logo_KFC.svg.png"));
        logo.setBounds(-10, 0, width_menu, 200);  
        ...
        menu.add(logo);
        menu.setBackground(Color.decode("#f66464"));       
        int y=200;
        ...
        {   
            ...
            pn_listmenu[i].setBackground(Color.decode("#f66464")); // mới sửa
            ...
            pn_listmenu[i].addMouseListener(new java.awt.event.MouseAdapter() {
                ...
                public void mouseEntered(java.awt.event.MouseEvent evt) 
                {
                    for(int i=0;i<pn_listmenu.length;i++)
                    {
                         if(evt.getSource()==pn_listmenu[i])
                        {
                            pn_listmenu[i].setBackground(Color.decode("#ff5029"));   //mới sửa                       
                            continue;
                        }
                        pn_listmenu[i].setBackground(Color.decode("#f66464"));     //mới sửa                   
                    }
