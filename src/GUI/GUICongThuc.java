...
public class GUICongThuc extends GUIFormContent{
    ...
    private void Them_Frame() {
        ...
        Luu.setBackground(Color.decode("#f66464"));
        ...
        Thoat.setBackground(Color.decode("#f66464"));
    ...
    private void Sua_Frame() {
        ...
        Title.setFont(new Font("Time New Roman", Font.BOLD, 21));
        Title.setForeground(Color.decode("#f66464"));
        Title.setBounds(150, 0, 200, 40);
        Sua.add(Title);
        int y = 50;
        ...
        for (int i = 0; i < array_CongThuc.length; i++) {
            ...
            if(i==1)
            {
                ...
                SuaMonAn.setBorder(BorderFactory.createLineBorder(Color.decode("#f66464"), 1));
